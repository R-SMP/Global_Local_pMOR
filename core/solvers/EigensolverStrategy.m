classdef EigensolverStrategy < Solver
    ...
    methods
        ...
        function obj = EigensolverStrategy(femModel, varargin)
        ...
        function assignModeShapes(obj)
            ...
            obj.femModel.getProcessInfo.setValue('FREQUENCY', obj.eigenfrequencies);
        end
        ...
        function solveModalSuperposition(obj, excitations, nModes)
            %HARMONIC ANALYSIS performs a modal superposition analysis in 
            % frequency domain
