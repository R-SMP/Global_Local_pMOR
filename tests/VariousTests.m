classdef VariousTests <  matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        %MODELPARTTEST tests the behavior of modelparts
            ...
            model.addNewCondition('PointLoadCondition3d1n',1,3);
            ...
            model.addNewModelPart('mp2',[2 3 4],[2 3],1);
            ...
            testCase.verifyEqual(model.getModelPart('mp2').getConditions().getNodes().getId(),3);
        end
        ...
        function addToModelPartTest(testCase)
            ...
            c1 = mp2.addNewCondition('PointLoadCondition3d1n',1,[n2]);
            ...
            testCase.verifyEqual(model.getCondition(1),mp2.getConditionById(1));
            ...
            testCase.verifyError(@() mp1.getConditionById(1), ...
                'MATLAB:bm_mfem:conditionNotFound');
        end
