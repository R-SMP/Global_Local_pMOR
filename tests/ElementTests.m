classdef ElementTests < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testSpringDamperElement3d2n(testCase)
            ...
            model.getAllElements().setPropertyValue('ELEMENTAL_DAMPING',20);
        ...
        function testBeamElement3d2nStatic(testCase)
            ...
            model.setPropertyValue('IY',1000);
            model.setPropertyValue('IZ',100);
            model.setPropertyValue('IT',100);
            model.setPropertyValue('YOUNGS_MODULUS',3000);
            model.setPropertyValue('POISSON_RATIO',0.3);
            model.setPropertyValue('CROSS_SECTION',3000);
            model.setPropertyValue('DENSITY',1);
        ...
        function testBeamElement3d2nEigen(testCase)
            ...
            model.setPropertyValue('IY',0.00001);
            model.setPropertyValue('IZ',0.00001);
            model.setPropertyValue('IT',0.00001);
            model.setPropertyValue('YOUNGS_MODULUS',2.1e11);
            model.setPropertyValue('POISSON_RATIO',0.3);
            model.setPropertyValue('CROSS_SECTION',.01);
            model.setPropertyValue('DENSITY',7850);
        ...
        function testReissnerMindlinElement3d4nStatic (testCase)
            ...
            % Properties
            model.setPropertyValue('YOUNGS_MODULUS', 10920);
            model.setPropertyValue('POISSON_RATIO', 0.3);
            model.setPropertyValue('THICKNESS', 0.1);
            model.setPropertyValue('NUMBER_GAUSS_POINT', 4);
            model.setPropertyValue('SHEAR_CORRECTION_FACTOR', 5/6);
        ...
        function testReissnerMindlinElement3d4nDynamic (testCase)
            ...
            % Properties
            model.setPropertyValue('THICKNESS', .00125);
            model.setPropertyValue('YOUNGS_MODULUS', 2.07e11);
            model.setPropertyValue('POISSON_RATIO', 0.3);
            model.setPropertyValue('NUMBER_GAUSS_POINT', 4);
            model.setPropertyValue('DENSITY', 7850);
            model.setPropertyValue('SHEAR_CORRECTION_FACTOR', 5/6);
        ...
        function testReissnerMindlinElement3d4nEigen (testCase)
            ...
            model.setPropertyValue('YOUNGS_MODULUS', 10920);
            model.setPropertyValue('POISSON_RATIO', 0.3);
            model.setPropertyValue('THICKNESS', 0.01);
            model.setPropertyValue('DENSITY', 1);
            model.setPropertyValue('NUMBER_GAUSS_POINT', 4);
            model.setPropertyValue('SHEAR_CORRECTION_FACTOR', 5/6);
        ...
        function testShellElement3d4nStatic (testCase)
            ...
            model.setPropertyValue('YOUNGS_MODULUS', 2.1e11);
            model.setPropertyValue('POISSON_RATIO', 0.3);
            model.setPropertyValue('THICKNESS', 0.005);
        ...
        function testShellElement3d4nDynamic(testCase)
            ...
            % Properties
            model.setPropertyValue('USE_CONSISTENT_MASS_MATRIX',1);
            model.setPropertyValue('YOUNGS_MODULUS', 2.1e11);
            model.setPropertyValue('POISSON_RATIO', 0.3);
            model.setPropertyValue('THICKNESS', 0.005);
            model.setPropertyValue('DENSITY',7860);
            model.setPropertyValue('RAYLEIGH_ALPHA',3);
            model.setPropertyValue('RAYLEIGH_BETA',4e-4);
            model.setPropertyValue('NUMBER_GAUSS_POINT',2);
        ...
        function testAcousticElement2d4n (testCase)
            import matlab.unittest.constraints.IsEqualTo
            import matlab.unittest.constraints.AbsoluteTolerance
        ...
        function testClassicalPorousElement2d4n (testCase)
            import matlab.unittest.constraints.IsEqualTo
            import matlab.unittest.constraints.AbsoluteTolerance
            ...
            [model] = createRectangularPlate(Lx, Ly, nx, ny, 'elementType', 'ClassicalPorousElement2d4n');
            model.getAllNodes.addDof({'DISPLACEMENT_X', 'DISPLACEMENT_Y', 'DISPLACEMENT_FLUID_X', 'DISPLACEMENT_FLUID_Y'});
            ...
            assembling = SimpleAssembler;
            stiffnessMatrix = assembling.assembleGlobalStiffnessMatrix(model);
            massMatrix = assembling.assembleGlobalMassMatrix(model);
            dynamicStiffnessMatrix = stiffnessMatrix - ((2*pi*100)^2)*massMatrix;
            
            actualSolution = full(dynamicStiffnessMatrix(18,1));
            
            expectedSolution = -24466.3398080276 - 1254.93166592642i;
            testCase.assertThat(actualSolution, IsEqualTo(expectedSolution, ...
                'Within', AbsoluteTolerance(1e-7)))
        end
        
        function testMixedPorousElement2d4n (testCase)
            import matlab.unittest.constraints.IsEqualTo
            import matlab.unittest.constraints.AbsoluteTolerance

            io = MdpaInput('Porous_domain.mdpa');
            model = io.readModel;

            model.getAllNodes.addDof(["DISPLACEMENT_X","DISPLACEMENT_Y","ACOUSTIC_PRESSURE"]);
            ...
            actualSolution = model.getNode(4).getDof('ACOUSTIC_PRESSURE').getValue('end');
            
            expectedSolution = -0.294984281865570 - 0.0655974180168888i;
            testCase.assertThat(actualSolution, IsEqualTo(expectedSolution, ...
                'Within', AbsoluteTolerance(1e-7)))
        end
