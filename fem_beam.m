...
% Institute of Automatic Control, Technische Universit¨at M¨unchen, 2009
%
% Usage example: sys = fem beam(1); % for beam of length L=1m
%
% Authors: J¨org Hubele (joerg.hubele@mytum.de)
...
% ========== assembly ==========
% global mass and stiffness matrices: N*(6+1) dofs %Can assign this to the
% BM-FEM model
M = zeros(6*(N+1), 6*(N+1));
K = zeros(6*(N+1), 6*(N+1));
% assembly
