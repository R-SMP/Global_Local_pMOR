% GIDOUTPUTEXAMPLE Read a large mdpa model and export the results to GiD
clear
close all
...
out = GiDOutput('examples/GiDOutputExample');
out.setPreference('writeModelParts',false);
out.writeMesh(model);
out.setPreference('nodalResults',["DISPLACEMENT","ROTATION"]);
