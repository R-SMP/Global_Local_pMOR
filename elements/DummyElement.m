classdef DummyElement < Element
    ...
    methods
        ...
        function dampingMatrix = computeLocalDampingMatrix(obj)
            dampingMatrix = obj.dampingMatrix;
        end
        ...
        function setElementTable(obj, table)
            obj.elementTable = table;
        end
        
        function setNodeConnectivity(obj, nc, elementTypes)
            obj.nodeConnectivity = nc;
            obj.elementTypes = elementTypes;
        end
        
        function table = getElementTable(obj)
            table = obj.elementTable;
        end
        
        function [nc, et] = getNodeConnectivity(obj)
            nc = obj.nodeConnectivity;
            et = obj.elementTypes;
        end
    end
